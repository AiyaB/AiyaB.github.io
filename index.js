...
function toggleInfo(toggle){
    if(toggle.nextElementSibling.style.display!="none"){
        ...
        toggle.firstChild.src="../assets/plus.png";
    }
    else{
        toggle.nextElementSibling.style.display="block";
        toggle.firstChild.src="../assets/minus.png";
    }
}
...
function placeClick(place,imgRatio,name,nameWid,dist){
    ...
    mapImgDist.innerHTML=dist+"m from Wallabyyy<image id='gmapImg' src='Google-Maps-Symbol.png' alt='Google Maps Link'/>";
